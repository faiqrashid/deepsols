<!DOCTYPE html>
<html lang="en">
<!-- Mirrored from themelooks.us/demo/cloudserver/html/preview/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 29 May 2022 08:56:34 GMT -->
...
<head>
    ...
    <link href='https://fonts.googleapis.com/css?family=Roboto:300,400,500,700,900%7CMontserrat:700' rel='stylesheet'
        type='text/css'>
    ...
    <link href="{{ url('css/fakeLoader.css') }}" rel="stylesheet" type='text/css'>
    <link href="{{ url('style.css') }}" rel="stylesheet">
    <link href="{{ url('css/responsive-style.css') }}" rel="stylesheet">
    <link href="{{ url('css/colors/theme-color-1.css') }}" rel="stylesheet" id="changeColorScheme">
...
<body>
    ...
    <div id="menu">
        <div id="promo" class="alert">
            ...
            <div class="container">
                <p><strong>Cyber Monday! </strong>Up To<strong> 98% Off</strong> All Of Your New Order. Coupon Code:
                    "<strong>cm98</strong>". Time Left: <strong data-counter-down="2017/11/29">00:00:00</strong></p><a
                    href="#" class="btn btn-custom">Click Here</a>
            </div>
        </div>
            ...
            <div class="container">
                ...
                <div id="secondaryNavbar" class="navbar-right reset-padding hidden-sm hidden-xs">
                    <ul class="secondary-menu-links nav navbar-nav">
                        ...
                        <li> <a href="#" class="dropdown-toggle" data-toggle="dropdown">Hosting <span
                                    class="caret"></span></a>
                        ...
                        <li> <a href="#" class="dropdown-toggle" data-toggle="dropdown">Pages <span
                                    class="caret"></span></a>
                            <ul class="dropdown-menu">
                        ...
                        <li> <a href="#" class="dropdown-toggle" data-toggle="dropdown">Blog <span
                                    class="caret"></span></a>
                            <ul class="dropdown-menu">
        ...
        <div class="off-canvas-menu">
            ...
            <div class="off-canvas-menu-logo">
                <a href="index-2.html"> <img src="img/logo-offcanvas.png" alt="" class="img-responsive center-block" />
                </a>
            </div>
            <ul class="nav nav-pills nav-stacked">
                <li class="active"><a href="index-2.html"><i class="fa fa-fw fa-home"></i> Home</a></li>
                <li>
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <i class="fa fa-fw fa-server"></i>
                        Hosting <span class="caret"></span> </a>
                    <ul class="dropdown-menu">
                        <li><a href="shared-hosting.html"><i class="fa fa-fw fa-angle-right"></i> Shared Hosting</a>
                        </li>
                        <li><a href="reseller-hosting.html"><i class="fa fa-fw fa-angle-right"></i> Reseller Hosting</a>
                        </li>
                        <li><a href="vps-hosting.html"><i class="fa fa-fw fa-angle-right"></i> VPS Hosting</a></li>
                        <li><a href="dedicated-hosting.html"><i class="fa fa-fw fa-angle-right"></i> Dedicated
                                Hosting</a></li>
                    </ul>
                </li>
                <li><a href="domain.html"><i class="fa fa-fw fa-at"></i> Domain</a></li>
                <li> <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-fw fa-copy"></i> Pages
                        <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="about.html"><i class="fa fa-fw fa-angle-right"></i> About</a></li>
                        <li><a href="service-details.html"><i class="fa fa-fw fa-angle-right"></i> Service Details</a>
                        </li>
                ...
                <li> <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-fw fa-newspaper-o"></i>
                        Blog <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="blog.html"><i class="fa fa-fw fa-angle-right"></i> Blog</a></li>
                        <li><a href="blog-details-left.html"><i class="fa fa-fw fa-angle-right"></i> Blog Details
                                Left</a></li>
                        <li><a href="blog-details-right.html"><i class="fa fa-fw fa-angle-right"></i> Blog Details
                                Right</a></li>
                    </ul>
                </li>
                <li><a href="contact.html"><i class="fa fa-fw fa-envelope-o"></i> Contact</a></li>
            </ul> <a href="login.html" class="btn btn-default login-button"><i class="fa fa-user"></i> Login</a>
        </div>
    ...
    <div id="banner">
        <div class="banner-slider" data-pagination="true">
                ...
                <div class="container">
                    <div class="row">
                                ...
                                <div class="vc-child">
                                    <section class="banner-item-content">
                                        ...
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Qui eaque explicabo
                                            blanditiis, commodi repellat cupiditate magni dolorem nulla porro.</p><a
                                            href="#" class="btn btn-lg btn-custom">View Details</a>
                                    </section>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 hidden-sm hidden-xs">
                            <div class="vc-parent">
                                <div class="vc-child">
                                    <div class="banner-item-img"> <img src="img/home-slider-img/slider-item-01.png"
            ...
            <div class="banner-item bg--overlay" data-bg-img="img/home-slider-img/slider-bg-02.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 hidden-sm hidden-xs">
                            <div class="vc-parent">
                                <div class="vc-child">
                                    <div class="banner-item-img"> <img src="img/home-slider-img/slider-item-02.png"
                                            alt="" class="img-responsive"> </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="vc-parent">
                                <div class="vc-child">
                                    <section class="banner-item-content">
                                        <h1><span>VPS</span> Hosting Services</h1>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Qui eaque explicabo
                                            blanditiis, commodi repellat cupiditate magni dolorem nulla porro.</p><a
                                            href="#" class="btn btn-lg btn-custom">View Details</a>
                                    </section>
            ...
            <div class="banner-item bg--overlay" data-bg-img="img/home-slider-img/slider-bg-03.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="vc-parent">
                                <div class="vc-child">
                                    <section class="banner-item-content">
                                        <h1><span>Dedicated</span> Hosting Services</h1>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Qui eaque explicabo
                                            blanditiis, commodi repellat cupiditate magni dolorem nulla porro.</p><a
                                            href="#" class="btn btn-lg btn-custom">View Details</a>
                                    </section>
                        ...
                        <div class="col-md-6 hidden-sm hidden-xs">
                            <div class="vc-parent">
                                <div class="vc-child">
                                    <div class="banner-item-img"> <img src="img/home-slider-img/slider-item-03.png"
                                            alt="" class="img-responsive"> </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="vc-parent">
                                <div class="vc-child">
                                    <section class="banner-item-content text-center">
                                        <h1><span>Background</span> Video Slider</h1>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Qui eaque explicabo
                                            blanditiis, commodi repellat cupiditate magni dolorem nulla porro.</p><a
                                            href="#" class="btn btn-lg btn-custom">View Details</a>
                                    </section>
        ...
        <div class="banner--slider-nav">
            <div class="container">
                <ul>
                    <li class="active">
                        <p>Shared Hosting<small>lorem ipsum dolor sit amet</small></p>
                    </li>
                    <li>
                        <p>VPS Hosting<small>lorem ipsum dolor sit amet</small></p>
                    </li>
                    <li>
                        <p>Dedicated Hosting<small>lorem ipsum dolor sit amet</small></p>
                    </li>
                    <li>
                        <p>Video Slider<small>lorem ipsum dolor sit amet</small></p>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="row content">
                ...
                <div class="col-md-8 right-content">
                    <div data-form-validation="true">
                        <form action="http://billing.ywhmcs.com/domainchecker.php?systpl=CloudServer" method="post"
                            id="domainSearchForm">
                    ...
                    <div class="row domain-ext hidden-xs">
                        <div class="col-sm-2">
                            <a href="#" class="extension"> <span class="name">.com</span>
                                <span>$3.99/year</span> </a>
                        </div>
                        <div class="col-sm-2">
                            <a href="#" class="extension"> <span class="name">.net</span>
                                <span>$3.99/year</span> </a>
                        </div>
                        <div class="col-sm-2">
                            <a href="#" class="extension"> <span class="name">.org</span>
                                <span>$3.99/year</span> </a>
                        </div>
                        <div class="col-sm-2">
                            <a href="#" class="extension"> <span class="name">.info</span>
                                <span>$3.99/year</span> </a>
                        </div>
                        <div class="col-sm-2">
                            <a href="#" class="extension"> <span class="name">.us</span>
                                <span>$3.99/year</span> </a>
                        </div>
                        <div class="col-sm-2">
                            <a href="#" class="extension"> <span class="name">.eu</span>
                                <span>$3.99/year</span> </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6 feature--item">
                    <div class="feature--icon">
                        <div class="vc-parent">
                            <div class="vc-child"> <img src="img/features-img/icon-01.png" alt=""
                                    class="img-responsive center-block" /> </div>
                        </div>
                    </div>
                    <div class="feature--content">
                        <h4>Firewall</h4>
                        <p>Lorem ipsum dolor sit amet, placeat necessitatibus adipisicing elit.</p><a href="#"
                ...
                <div class="col-md-3 col-sm-6 feature--item">
                    <div class="feature--icon">
                        <div class="vc-parent">
                            <div class="vc-child"> <img src="img/features-img/icon-02.png" alt=""
                                    class="img-responsive center-block" /> </div>
                        </div>
                    </div>
                    <div class="feature--content">
                ...
                <div class="col-md-3 col-sm-6 feature--item">
                    <div class="feature--icon">
                        <div class="vc-parent">
                            <div class="vc-child"> <img src="img/features-img/icon-03.png" alt=""
                                    class="img-responsive center-block" /> </div>
                        </div>
                    </div>
                    <div class="feature--content">
                ...
                <div class="col-md-3 col-sm-6 feature--item">
                    <div class="feature--icon">
                        <div class="vc-parent">
                            <div class="vc-child"> <img src="img/features-img/icon-04.png" alt=""
                                    class="img-responsive center-block" /> </div>
                        </div>
                    </div>
                    <div class="feature--content">
            ...
            <div class="pricing--slider">
                <div class="pricing--item">
                    <div class="pricing--content">
                        ...
                        <div class="pt-footer"> <a href="#" class="btn btn-lg btn-custom">Order Now</a> </div>
                    </div>
                </div>
                <div class="pricing--item">
                    <div class="pricing--content">
    ...
    <div id="subscribe" class="bg--overlay" data-bg-img="img/subscribe-img/bg.jpg">
        <div class="container">
            <div class="section-title">
                ...
                <div class="col-md-6 col-md-offset-3">
                    <div data-form-validation="true">
                        <form
                            ...
                            method="post" name="mc-embedded-subscribe-form" target="_blank" id="subscribeForm"
    ...
    <div id="featuresTab" class="bg--lightgray">
        <div class="container">
            ...
            <div class="features-tab--nav">
                <ul>
                    <li class="active"><a href="#featuresTabItem01" class="btn btn-lg btn-custom"
                            data-toggle="tab">High-Performance</a></li>
                    <li><a href="#featuresTabItem02" class="btn btn-lg btn-custom" data-toggle="tab">Enhanced
                            Security</a></li>
                    <li><a href="#featuresTabItem03" class="btn btn-lg btn-custom" data-toggle="tab">Spam Guard</a>
                    </li>
                    <li><a href="#featuresTabItem04" class="btn btn-lg btn-custom" data-toggle="tab">Unbeatable
                            Support</a></li>
                    <li><a href="#featuresTabItem05" class="btn btn-lg btn-custom" data-toggle="tab">99.9% Uptime</a>
                    </li>
                </ul>
            </div>
            <div class="features-tab--items tab-content">
                <div class="features-tab--item tab-pane fade in active" id="featuresTabItem01">
                    <div class="row row-vc">
                        <div class="features-tab--content col-md-6">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolore reprehenderit laborum,
                                ab exercitationem sunt aliquam illo! Aliquid labore animi, alias ratione ad
                                necessitatibus ipsa perspiciatis. Quae architecto totam, reprehenderit ipsa.</p>
                            <ul>
                                <li><i class="fa fa-check"></i>Lorem ipsum dolor sit amet</li>
                                <li><i class="fa fa-check"></i>Lorem ipsum dolor sit amet</li>
                                <li><i class="fa fa-check"></i>Lorem ipsum dolor sit amet</li>
                        ...
                        <div class="features-tab--img col-md-6"> <img
                                src="img/features-tab-img/features-tab-item-01.png" alt="" class="img-responsive" />
                        </div>
                    </div>
                </div>
                <div class="features-tab--item tab-pane fade" id="featuresTabItem02">
                    <div class="row row-vc">
                        <div class="features-tab--img col-md-6"> <img
                                src="img/features-tab-img/features-tab-item-02.png" alt="" class="img-responsive" />
                        </div>
                        <div class="features-tab--content col-md-6">
                ...
                <div class="features-tab--item tab-pane fade" id="featuresTabItem03">
                    <div class="row row-vc">
                        ...
                        <div class="features-tab--img col-md-6"> <img
                                src="img/features-tab-img/features-tab-item-03.png" alt="" class="img-responsive" />
                        </div>
                    </div>
                </div>
                <div class="features-tab--item tab-pane fade" id="featuresTabItem04">
                    <div class="row row-vc">
                        <div class="features-tab--img col-md-6"> <img
                                src="img/features-tab-img/features-tab-item-04.png" alt="" class="img-responsive" />
                        </div>
                        <div class="features-tab--content col-md-6">
                ...
                <div class="features-tab--item tab-pane fade" id="featuresTabItem05">
                    <div class="row row-vc">
                        ...
                        <div class="features-tab--img col-md-6"> <img
                                src="img/features-tab-img/features-tab-item-05.png" alt="" class="img-responsive" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="testimonial-slider">
                <div class="testimonial-item">
                    <div class="recommender-comment">
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Earum similique ad, magnam, odit
                            repellat reprehenderit. Consequatur consectetur aspernatur ad assumenda a. Aspernatur fugit
                            numquam quod rerum sint facere ex ullam. A, blanditiis quod, tempore magni veniam
                            perferendis aliquid vitae saepe.</p>
                    </div>
                    <div class="recommender-img"> <img src="img/testimonial-img/01.jpg" alt=""
                            class="img-responsive" /> </div>
                    <div class="recommender-info"> <span class="recommender-name">John Doe,</span> <span
                            class="recommender-role">Company</span> </div>
                </div>
                <div class="testimonial-item">
                    <div class="recommender-comment">
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Earum similique ad, magnam, odit
                    ...
                    <div class="recommender-img"> <img src="img/testimonial-img/02.jpg" alt=""
                            class="img-responsive" /> </div>
                    <div class="recommender-info"> <span class="recommender-name">Mohammad Al Omayer,</span> <span
                            class="recommender-role">Company</span> </div>
                </div>
                <div class="testimonial-item">
                    <div class="recommender-comment">
                    ...
                    <div class="recommender-img"> <img src="img/testimonial-img/03.jpg" alt=""
                            class="img-responsive" /> </div>
                    <div class="recommender-info"> <span class="recommender-name">Jane Doe,</span> <span
                            class="recommender-role">Company</span> </div>
                </div>
            </div>
        </div>
    ...
    <div id="contactInfo">
        <div class="container">
            <div class="row reset-gutter">
                <div class="contact-info--item col-md-3 col-xs-6"> <a href="#"><i class="fa fa-headphones"></i>24/7
                        Customer Support</a> </div>
                <div class="contact-info--item col-md-3 col-xs-6"> <a href="#"><i
                            class="fa fa-envelope-o"></i>support@example.com</a> </div>
                <div class="contact-info--item col-md-3 col-xs-6"> <a href="#"><i class="fa fa-comments-o"></i>Click
                        Here To Live Chat</a> </div>
                <div class="contact-info--item col-md-3 col-xs-6"> <a href="#"><i class="fa fa-phone"></i>+44 000
                        000 000</a> </div>
            </div>
        </div>
    </div>
    ...
    <script src="{{ url('js/jquery.tubular.1.0.js') }}"></script>
    ...
    <script src="{{ url('js/custom-color-switcher.js') }}"></script>
    <script src="{{ url('js/retina.min.js') }}"></script>
    <script src="{{ url('js/main.js') }}"></script>
</body>
<!-- Mirrored from themelooks.us/demo/cloudserver/html/preview/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 29 May 2022 08:58:04 GMT -->
